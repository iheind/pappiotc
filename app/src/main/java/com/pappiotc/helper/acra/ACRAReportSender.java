package com.pappiotc.helper.acra;
...
/**
 * Acra is crash reporting tool that is used to send crash reports
 */
public class ACRAReportSender implements ReportSender {
    ...
    public void send(Context context, CrashReportData report)
        ...
        try {
            ...
            gMailSender.sendMail("Sales Tracker - CRASH REPORT", reportBody, emailUsername, "aurora.sdp@gmail.com, aurora.crash.report@gmail.com");
        } catch (Exception e) {
